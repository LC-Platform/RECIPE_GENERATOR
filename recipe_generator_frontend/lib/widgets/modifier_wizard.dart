...
Widget _buildQuantityInput() {
  // Create a temporary map that holds the current quantity value.
  final Map<String, dynamic> relation = {
    'quantity': _selectedQuantity,
    // You may initialize the flag as needed (here, set to false by default).
    'isCustomQuantity': false,
  };

  return QuantitySelector(
    localNounRelation: relation,
